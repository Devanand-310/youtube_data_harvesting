...
with col1:
    ...
    if Get_data or st.session_state.Get_state:
        ...
        client = pymongo.MongoClient(
            'mongodb+srv://deva03102001:7871400420@cluster0.4xtn4hs.mongodb.net/?retryWrites=true&w=majority')
...
with col2:
    ...
    client = pymongo.MongoClient('mongodb+srv://deva03102001:7871400420@cluster0.4xtn4hs.mongodb.net/?retryWrites=true&w=majority')
    ...
    if Migrate or st.session_state_migrate_sql:
        ...
        engine = create_engine('mysql+mysqlconnector://root:Janu19042002@127.0.0.1/youtube_db', echo=False)
...
if Check_channel:
    ...
    engine = create_engine('mysql+mysqlconnector://root:Janu@19042002@127.0.0.1/youtube_db', echo=False)
...
connect_for_question = pymysql.connect(host='127.0.0.1', user='root', password='Janu19042002', db='youtube_db')
